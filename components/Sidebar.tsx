        ...
        >
          <div className={s.mobileSidebarHeader}>
            <div className={s.mobileHeaderInner}>
              <div
                className={s.mobileHeaderAvatarContainer}
              >
                <div className={s.mobileAvatar}>
                  <Image
                    src="/nm-logo.png"
          ...
          <div className={s.mobileContent}>
            <p className={s.mobileSectionLabel}>
              Navigation
            </p>
