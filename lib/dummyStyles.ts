...
export const contactPageStyles = {
  ...
  // Contact method card
  contactCard: "group flex items-center gap-4 rounded-xl border border-zinc-700/80 bg-zinc-900/50 p-4 transition-all hover:border-zinc-500 hover:bg-zinc-800/50 shadow-md shadow-black/20",
  ...
  contactIcon: "h-5 w-5",
  contactLabel: "text-sm font-medium text-zinc-400",
  contactValue: "text-zinc-200 transition-colors group-hover:text-zinc-100",

  // Form styles
  formContainer: "relative z-10 space-y-6 rounded-2xl border border-zinc-700/80 bg-zinc-900/50 p-6 md:p-8 shadow-xl shadow-black/40",
  formGrid: "grid grid-cols-1 gap-6 md:grid-cols-2",

  // Form field common styles
  formFieldContainer: "relative",
  formInput: "peer w-full rounded-xl border border-zinc-700 bg-zinc-900/60 px-4 py-4 text-zinc-100 outline-none transition-all placeholder:text-transparent focus:border-zinc-500 focus:bg-zinc-800 focus:ring-1 focus:ring-zinc-500",
  formTextarea: "peer w-full resize-none rounded-xl border border-zinc-700 bg-zinc-900/60 px-4 py-4 text-zinc-100 outline-none transition-all placeholder:text-transparent focus:border-zinc-500 focus:bg-zinc-800 focus:ring-1 focus:ring-zinc-500",
...
export const projectStyles = {
  ...
  projectImage: "h-full w-full transform object-contain bg-zinc-950 transition-transform duration-500 group-hover:scale-105",
  ...
  titleComponentAvatar: "rounded-full border border-zinc-700 object-cover w-full h-full object-center",
...
export const projectDetailStyles = {
  ...
  projectImage: "w-full h-auto aspect-video object-contain bg-zinc-950/50",
...
export const sidebarStyles = {
  ...
  mobileAvatarImage: "object-cover w-full h-full object-center",
  ...
  desktopAvatarImage: "object-cover w-full h-full object-center",
